  ...
  <div class="container" style="background: white;">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
        <h1 class="mt-4">&#40;HCM&#41; Top 10 Coffee shop cực chất khiến các tín đồ shopping điên đảo</h1>

        <div class="lead">
          <div class="row">
            <p>Đăng bởi &nbsp;</p>
            <img src="images/10-avatar.jpg" class="avatar" alt="">
            <a href="#" class="name-reviewer"> Mimi Nguyễn</a>
            <p>- lúc 14:38 02/06/2018</p>
          </div>
        </div>
        <hr>
        ...
        <blockquote class="blockquote author">
          <footer class="blockquote-footer">Someone famous in
            <cite title="Source Title">Mimi Nguyễn</cite>
          </footer>
        </blockquote>
            ...
            <div class="media mt-4">
              ...
              <div class="media-body">
                <div class="row">
                  ...
                  <p>Bên mình chuyên cung cấp hạt cà phê rang xay nguyên chất 100% giá cả cạnh tranh, giao hàng tận nơi trên
        ...
        <div class="media mb-4">
          ...
          <div class="media-body">
            <div class="row">
              ...
              <p>thêm 1 quán Cafe đẹp độc cho buôn làng nè https://www.youtube.com/watch?v=EzkXq0QYGaE&t=69s</p>
            </div>
            <a href="#" style="font-size: 15px;">Thích &nbsp;</a>
            <a href="#" style="font-size: 15px;">Trả lời</a>
          </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
          ...
          <div class="card">
            <div class="row mt-2 adv-content">
              <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <img class="img-fluid rounded mt-9 advertise-photo" src="images/advertisement-2.jpg" alt="">
              </div>
              <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9" style="padding:0">
                <div class="row">
                  <h3 style="font-size: 17px;text-decoration: none;font-style: normal;">Tự hào gắn kết</h3>
                </div>
                <div class="row">
                  <div class="col-xs-3 col-sm-3 col-md-4 col-lg-4" style="padding:0">
                    <button type="button" class="btn mb-2 btn-warning" style="color: white; padding: 0; height: 30px; font-size: 10px;">Quảng
                      cáo
                    </button>
                  </div>
        ...
        <div class="mt-3">
          <ul style="margin-top: 20px; visibility: visible;" class="test1 nav nav-tabs">
            <li style="text-align: center;padding: 0 10px; border: 1px solid lightgray; background-color:rgba(0,0,0,.03)">
              <a data-toggle="tab" href="#">Mới nhất</a></li>
            <li style="text-align: center;padding: 0 10px; margin-left: 10px"><a data-toggle="tab" href="#">Xem nhiều nhất
              </a></li>
          </ul>
          <div class="card">
            <div class="blog-post">
              <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                  <img class="d-flex mr-3 rounded my-2 blog-post-photo" src="images/blog-post-1.jpg" alt="">
                </div>
            ...
            <div class="blog-post">
              <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                  <img class="d-flex mr-3 rounded my-2 blog-post-photo" src="images/blog-post-2.jpg" alt="">
                </div>
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                  <a href="#">
                    <h4 class="mt-2" style="color:black">
                      Muốn làm Tiểu thư, Công tử nhất định phải ghé Quán ăn phong cách Dã Sử siêu đặc biệt này
                    </h4>
                  </a>
                </div>
              </div>
            ...
            <div class="blog-post">
              <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                  <img class="d-flex mr-3 rounded my-2 blog-post-photo" src="images/blog-post-3.jpg" alt="">
                </div>
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                  <a href="#">
                    <h4 class="mt-2" style="color:black">
            ...
            <div class="blog-post">
              <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                  <img class="d-flex mr-3 rounded my-2 blog-post-photo" src="images/blog-post-4.jpg" alt="">
                </div>
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                  <a href="#">
                    <h4 class="mt-2" style="color:black">
            ...
            <div class="blog-post">
              <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                  <img class="d-flex mr-3 rounded my-2 blog-post-photo" src="images/blog-post-5.jpg" alt="">
                </div>
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                  <a href="#">
                    <h4 class="mt-2" style="color:black">
