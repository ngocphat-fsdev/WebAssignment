        ...
        <ul class="nav-menu">
          ...
          <li>
            ...
            <ul>
              ...
              <li><a class="active" href="job-manage.php">Manage jobs</a></li>
            </ul>
          </li>
          <li>
            <a href="#">Resume</a>
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  ...
                  <div class="hgroup">
                    <h4><a href="job-detail.php">Senior front-end developer</a></h4>
                    <h5><a href="company-detail.php">Google</a></h5>
                  </div>
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="company-detail.php"><img src="assets/img/logo-google.jpg" alt=""></a>
                  <div class="hgroup">
                    <h4><a href="job-detail.php">Software Engineer (Entry or Senior)</a></h4>
                    <h5><a href="company-detail.php">Google</a></h5>
                  </div>
                  <div class="header-meta">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  ...
                  <div class="hgroup">
                    <h4><a href="job-detail.php">Full Stack Web Developer</a></h4>
                    <h5><a href="company-detail.php">Envato</a> <span class="label label-success">Filled</span></h5>
                  </div>
                  <div class="header-meta">
                    <span class="location">Menlo park, CA</span>
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  ...
                  <div class="hgroup">
                    <h4><a href="job-detail.php">Web Applications Developer</a></h4>
                    <h5><a href="company-detail.php">Facebook</a> <span class="label label-danger">No-one found</span></h5>
                  </div>
                  <div class="header-meta">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  ...
                  <div class="hgroup">
                    <h4><a href="job-detail.php">Sr. SQL Server Developer</a></h4>
                    <h5><a href="company-detail.php">Microsoft</a> <span class="label label-success">Filled</span></h5>
                  </div>
                  <div class="header-meta">
