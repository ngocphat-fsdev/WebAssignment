        ...
        <ul class="nav-menu">
          ...
          <li>
            ...
            <ul>
              ...
              <li><a class="active" href="job-candidates.php">Candidates</a></li>
            </ul>
          </li>
          <li>
            <a href="#">Resume</a>
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="resume-detail.php"><img class="resume-avatar" src="assets/img/avatar-1.jpg" alt=""></a>
                  <div class="hgroup">
                    <h4>
                      <a href="resume-detail.php">John Doe</a>
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="resume-detail.php"><img class="resume-avatar" src="assets/img/avatar-2.jpg" alt=""></a>
                  <div class="hgroup">
                    <h4>
                      <a href="resume-detail.php">Bikesh Soltanian</a>
                      <select class="form-control selectpicker label-style">
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="resume-detail.php"><img class="resume-avatar" src="assets/img/avatar-4.jpg" alt=""></a>
                  <div class="hgroup">
                    <h4>
                      <a href="resume-detail.php">Chris Hernandeziyan</a>
                      <select class="form-control selectpicker label-style">
                        <option data-content="<span class='label label-default'>New</span>">New</option>
                        <option data-content="<span class='label label-warning'>Contacted</span>">Contacted</option>
            ...
            <div class="col-xs-12">
              <div class="item-block">
                <header>
                  <a href="resume-detail.php"><img class="resume-avatar" src="assets/img/avatar-3.jpg" alt=""></a>
                  <div class="hgroup">
                    <h4>
                      <a href="resume-detail.php">Maryam Amiri</a>
                      <select class="form-control selectpicker label-style">
                        <option data-content="<span class='label label-default'>New</span>">New</option>
                        <option data-content="<span class='label label-warning'>Contacted</span>">Contacted</option>
                        <option data-content="<span class='label label-info'>Interviewed</span>">Interviewed</option>
