    ...
    <form action="#">
      ...
      <header class="page-header">
        <div class="container page-name">
          <h1 class="text-center">Add your blog</h1>
          <p class="lead text-center">Create your blog and put it online.</p>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
              <div class="form-group">
                <input type="text" class="form-control input-lg" placeholder="Title of blog">
              </div>

              <div class="form-group">
                <textarea class="form-control" rows="10" placeholder="Blog Content"></textarea>
              </div>
        ...
        <section class=" bg-img" style="background-image: url(assets/img/bg-facts.jpg);">
          <div class="container">
            <header class="section-header">
              ...
              <h2>Create blog</h2>
              <p>Please review your information once more and press the below button to put your blog online.</p>
            </header>

            <p class="text-center"><button name="updateBtn" class="btn btn-success btn-xl btn-round">Create your blog</button></p>
