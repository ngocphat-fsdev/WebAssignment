  ...
  <div id="myModal" class="modal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-3 "><img class="img-food" alt="No image" src="coffeehouse.jpg" /></div>

          <div class="col-lg-7 offset-lg-2">
            <h3>Chi tiết đơn hàng</h3>
            <div class="row">
              <div class="col-lg-9 font-weight-bold text">Coffee House - Cookies đá xay </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-3">
          ...
          <a class="path-link" href="">Đà nẵng >> </a>
          <a class="path-link" href="">Coffee House - Cookies đá xay</a>

          <a href="CartFood.php"><i class="fas fa-shopping-cart"> Xem giỏ hàng</i></a>
          <div class="restaurant">QUÁN ĂN</div>
          <div class="name-restaurant">Coffee house - Cookies đá xay</div>
          ...
          <button type="button" class="btn btn-danger btn-cart" id="myCart_10"> <i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng</button>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <table class="table table-hover list-food">
            ...
            <tbody>
              <tr>
                <th> <img src="tradenmacchiato.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Trà đen Macchiato</p>
                </td>
                <td>
                  <div class="price">
                    <p><del>50.000 đ</del></p>
                  </div>
                  <div class="discount"> 42.000 đ </div>
                </td>

                <td> <p id="added_11"><p> <button type="button" class="btn btn-danger add-food" id="btn_add_11" > <i class="fas fa-plus"></i> </button> </td>
              </tr>
              <tr>
                <th> <img src="matcha.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Matcha Macchiato </p>
                </td>
                <td>
                  <div class="price">
                    <p><del>48.000 đ</del></p>
                  </div>
                  <div class="discount"> 40.000 đ </div>
                </td>
                <td>
                  <p id="added_12"><p>
                  <button type="button" class="btn btn-danger add-food" id="btn_add_12">
                    <i class="fas fa-plus"></i>
                  </button>
                </td>
              </tr>
              <tr>
                <th> <img src="tradao.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Trà đào cam sả đá</p>
                </td>
                <td>
                  <div class="price">
                    <p><del>45.000 đ</del></p>
                  </div>
                  <div class="discount"> 35.000 đ </div>
                </td>
                <td>
                <p id="added_13"><p>
                  <button type="button" class="btn btn-danger add-food" id="btn_add_13">
                    <i class="fas fa-plus"></i>
                  </button>
                </td>
              </tr>
              <tr>
                <th> <img src="socoladaxay.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Sô cô la đá xay</p>
                </td>
                <td>
                  <div class="price">
                    <p><del>50.000 đ</del></p>
                ...
                <td>
                <p id="added_14"><p>
                  <button type="button" class="btn btn-danger add-food" id="btn_add_14">
                    <i class="fas fa-plus"></i>
                  </button>
                </td>
              </tr>
