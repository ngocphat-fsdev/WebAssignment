  ...
  <div id="myModal" class="modal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-3 "><img class="img-food" alt="No image" src="highlands.jpg" /></div>

          <div class="col-lg-7 offset-lg-2">
            <h3>Chi tiết đơn hàng</h3>
            <div class="row">
              <div class="col-lg-9 font-weight-bold text">Highlands cofffee - Combo 3 đồ uống </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-3">
          ...
          <a class="path-link" href="">Highlands coffee - Combo 3 đồ uống</a>

          <a href="CartFood.php"><i class="fas fa-shopping-cart"> Xem giỏ hàng</i></a>
          <div class="restaurant">QUÁN ĂN</div>
          <div class="name-restaurant">Highlands coffee - Combo 3 đồ uống</div>
            ...
            <div class="res-common-add">
              ...
              <span>
                <a href="" target="_blank">
                  <span>312- 314 Tùng Thiện Vương, P. 13</span>
                  ,
                </a>
              </span>
          ...
          <button type="button" class="btn btn-danger btn-cart" id="myCart_15"> <i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng</button>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <table class="table table-hover list-food">
            ...
            <tbody>
              <tr>
                <th> <img src="phinsuada.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Phin sữa đá</p>
                </td>
                <td>
                  <div class="price">
                    <p><del>38.000 đ</del></p>
                  </div>
                  <div class="discount"> 28.000 đ </div>
                </td>

                <td> <p id="added_16"><p> <button type="button" class="btn btn-danger add-food" id="btn_add_16" > <i class="fas fa-plus"></i> </button> </td>
              </tr>
              <tr>
                <th> <img src="phindenda.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Phin đen đá</p>
                </td>
                <td>
                  <div class="price">
                    <p><del>35.000 đ</del></p>
                  </div>
                  <div class="discount"> 28.000 đ </div>
                </td>
                <td>
                  <p id="added_17"><p>
                  <button type="button" class="btn btn-danger add-food" id="btn_add_17">
                    <i class="fas fa-plus"></i>
                  </button>
                </td>
              </tr>
              <tr>
                <th> <img src="bacxiu.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Bạc xỉu</p>
                </td>
                <td>
                  <div class="price">
                ...
                <td>
                <p id="added_18"><p>
                  <button type="button" class="btn btn-danger add-food" id="btn_add_18">
                    <i class="fas fa-plus"></i>
                  </button>
                </td>
              </tr>
              <tr>
                <th> <img src="phinsuanong.jpg" alt="No image" width="60" height="60"></th>
                <td>
                  <p class="font-weight-bold">Phin sữa nóng</p>
                </td>
                <td>
                  <div class="price">
                    <p><del>35.000 đ</del></p>
                ...
                <td>
                <p id="added_19"><p>
                  <button type="button" class="btn btn-danger add-food" id="btn_add_19">
                    <i class="fas fa-plus"></i>
                  </button>
                </td>
              </tr>
