...
if ($result->num_rows > 0) {
    echo "<table id=\"user_data\"><tr><th>ID</th><th>Name</th><th>Addr</th><th>Rating</th><th>Work</th><th>PicRes</th><th></th><th></th></tr>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td contenteditable class=\"pic-data\">" . $row["PictureRes"] . "</td>";
    ...
    echo "<td contenteditable id=\"data6\"></td>";
