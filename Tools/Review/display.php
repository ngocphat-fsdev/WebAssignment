...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr id=\"tr".$row["ID"]."\"><td contenteditable class=\"id-data\">" . $row["ID"] . "</td>";
        echo "<td contenteditable class=\"name-data\">" . $row["Name"] . "</td>";
        echo "<td contenteditable class=\"pic-data\">" . $row["PictureLink"] . "</td>";
        echo "<td contenteditable class=\"price-data\">" . $row["Price"] . "</td>";
        echo "<td contenteditable class=\"resid-data\">" . $row["ResID"] . "</td>";
        echo "<td><button id=\"".$row["ID"]."\" class=\"edit\">Edit</button></td>";
